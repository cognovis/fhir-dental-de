...
- **PVS vendors** implementing FHIR-based data exchange
...
- [**de.cognovis.fhir.praxis**](https://fhir.cognovis.de/praxis/) (0.91.0) — Shared extensions (Abrechnungsquartal, Scheintyp, Steigerungsfaktor)
