...
- [DentalClinicalImpressionDE](StructureDefinition-de-mira-dental-clinical-impression.html) — Behandlungsjournal (ClinicalImpression)

#### Billing Profiles
- [BemaChargeItemDE](StructureDefinition-de-mira-bema-charge-item.html) — BEMA Leistungsposition (ChargeItem)
- [GozChargeItemDE](StructureDefinition-de-mira-goz-charge-item.html) — GOZ Leistungsposition (ChargeItem)
...
- [DentalImagingStudyDE](StructureDefinition-de-mira-dental-imaging-study.html) — Röntgendiagnostik (ImagingStudy)
- [DentalLabServiceRequestDE](StructureDefinition-de-mira-dental-lab-service-request.html) — Laborauftrag (ServiceRequest)
