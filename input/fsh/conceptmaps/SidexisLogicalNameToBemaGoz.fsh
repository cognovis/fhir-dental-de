...
//   adapter-7os (Strahlen-Code-Whitelist)

Instance: SidexisLogicalNameToBemaGoz
InstanceOf: ConceptMap
Usage: #definition
Title: "Sidexis LogicalName → BEMA + GOZ Vorschlag"
Description: "Mapping von Sidexis 4 LogicalName-Aufnahmetypen auf GKV-BEMA- und GOZ-Privatpositionen für die zahnärztliche Röntgen-Review-Abrechnung. Quellen: GOZ-Katalog (BZAEK), BEMA-Z (KZBV), zahnrad/tools/Roentgen-Review/README.md (Praxis-Validierung), adapter-7os (Strahlen-Code-Whitelist)."
