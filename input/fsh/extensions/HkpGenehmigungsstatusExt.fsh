...
Description: "Genehmigungsstatus des Heil- und Kostenplans (HKP) bei der Krankenkasse."
...
* extension[ehkp-id].value[x] only string
* extension[ehkp-id].value[x] ^short = "EBZ-Referenznummer für den elektronischen HKP"
