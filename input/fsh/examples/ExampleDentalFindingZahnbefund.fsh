...
Description: "SWS-2.0-Zahnstatus c (kariös) an Zahn 26. Die klinische Diagnose und Flächendetails bleiben getrennte Befunde."
...
* valueCodeableConcept.text = "SWS 2.0 tooth-chart status: carious"
