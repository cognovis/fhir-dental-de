...
* identifier[0].system = "https://example-dental-practice.de/labor-id"
...
* type[0] = http://terminology.hl7.org/CodeSystem/organization-type#bus "Non-Healthcare Business or Corporation"
