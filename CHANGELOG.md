...
- **dependency**: Re-pinned `de.cognovis.fhir.praxis` from `0.79.0` to `0.80.0` (release-cascade re-pin onto the rebuilt praxis foundation). Released as `0.38.1` via the fhir-management cascade (supersedes the never-published `0.38.0` bump).
